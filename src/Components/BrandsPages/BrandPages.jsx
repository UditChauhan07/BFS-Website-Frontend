...
import Aerin from '../../pages/Aerin/Aerin';
function BrandPages() {
             ...
             {data?.map((item)=>(
                  ...
                  <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 m-auto">
                    <div className="BnadLogo w-100">
                      <img className="img-fluid" src={`${originAPi}${item?.Image_1__c}`} />
                    </div>
                  </div>
                  <div className="col-xl-8 col-lg-8 col-md-12 col-sm-12 m-auto ">
                    <div className="row">
                      <div className="col-xl-7 col-lg-6 col-md-12 col-sm-12 borderRight">
                        <img className="img-fluid heightWidth" src={`${originAPi}${item?.Additional_Images__c}`} />
                      </div>
                 ...
                 {topProductData.map((item) => (
                   <div className="item" key={item.Id}>
                     <div className="ArriavalsInnerContent">
                       ...
                       <a href="https://portal.beautyfashionsales.com/">Shop The Collection</a>
                       <div className="fitContent">
                         <img src={`${originAPi}${item?.Image_1__c}`} alt="Top Product" />
                       </div>
                     </div>
                   </div>
                 ))}
